...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=339173');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "339173");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "ef399f91b24ac53c9dad14e391e710c4c468f5ba2c4036682273faca5afea78e");
define('CREATED_TIMESTAMP', "1595284833");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor339173');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor339173');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "erosmedia.tk",
));
